...
public class MyServer {
    ...
    synchronized public MyMessage result_vote() {
        MyMessage res = new MyMessage("result", "Voting is finished. Pro: " + Integer.toString(count_pro) + ", Con: " + Integer.toString(count_con) + "\n");
        count_pro = 0;
        count_con = 0;
        return res;
    }
