...
public class MyServer {
    ...
    public MyServer(int _port) throws SQLException, ClassNotFoundException{
        port = _port;
        yes = 0;
        no = 0;
        isVoting = false;
    ...
    public void serverStart() throws IOException, InterruptedException, SQLException{
        ...
        while (true)
        {
             ...
             id++;
             clientsSize++;
             clients.add(new ThreadClient(cs, id, this, DB));
